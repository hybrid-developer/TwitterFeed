...
@Keep
data class TwitterFeedResponse(
    @SerializedName("contributors") val contributors: Any?,
    @SerializedName("coordinates") val coordinates: Any?,
    @SerializedName("created_at") val createdAt: String,
    @SerializedName("display_text_range") val displayTextRange: List<Int>,
    ...
    @SerializedName("geo") val geo: Any?,
    @SerializedName("id") val id: Long,
    @SerializedName("id_str") val idStr: String,
    @SerializedName("in_reply_to_screen_name") val inReplyToScreenName: Any?,
    @SerializedName("in_reply_to_status_id") val inReplyToStatusId: Any?,
    @SerializedName("in_reply_to_status_id_str") val inReplyToStatusIdStr: Any?,
    @SerializedName("in_reply_to_user_id") val inReplyToUserId: Any?,
    @SerializedName("in_reply_to_user_id_str") val inReplyToUserIdStr: Any?,
    ...
    @SerializedName("retweeted_status") val retweetedStatus: RetweetedStatus,
