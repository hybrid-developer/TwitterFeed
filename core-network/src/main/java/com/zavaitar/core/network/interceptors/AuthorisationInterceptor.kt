...
internal class AuthorisationInterceptor @Inject constructor() : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (authorisationToken.isNotEmpty() && chain.request().header(AUTHORISATION_HEADER_KEY) == null) {
    ...
    private companion object {
        ...
        private const val AUTHORISATION_TOKEN = "AAAAAAAAAAAAAAAAAAAAAF7w0wAAAAAAb6kdTQSU%2F5EmGAMD917iN7rZuVE%3D9ssQYqmHSgDTUgLDOW3k155qYVOxrGUaDSeOrW3IqvHeSoRYiu"
    }
}
